@extends('layouts.app', ['title' => $title ?? 'Flujos - Crear'])
            ...
            <div class="row align-items-end">
                ...
                <div class="col-lg-4">
                    ...
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('wordflows.create') }}">Crear</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <form method="POST" action="" name="form-wordflow-create-steps" id="form-wordflow-create-steps">
                    ...
                    <h4 class="sub-title">Pasos del flujo
                        <div class="label-main">
                            <label class="label label-inverse" style="cursor: pointer !important;">Nuevos Pasos</label>
                        </div>
                    </h4>
